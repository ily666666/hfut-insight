...
const platformMark = computed(() => (props.platform === 'skill' ? '技' : '视'));
...
function openTaskCenter() {
  router.push({ name: 'TaskCenter' }).catch(() => {});
}
</script>
...
<template>
  <aside class="primary-sidebar">
    ...
    <nav class="menu" aria-label="一级导航">
      <button
        v-for="item in items"
        :key="item.key"
    ...
    <div class="footer">
      <button class="footer-action" type="button" title="任务中心" @click="openTaskCenter">
