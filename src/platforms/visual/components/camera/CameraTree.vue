...
import { useDragChannel } from '@/platforms/visual/composables/useDragChannel';
import type { CameraChannel, CameraGroup } from '@/platforms/visual/types/monitor';
...
type CameraChannelNode = import('@/platforms/visual/types/monitor').CameraChannel;
type CameraGroupNode = import('@/platforms/visual/types/monitor').CameraGroup;
