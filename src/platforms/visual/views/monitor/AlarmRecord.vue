...
import { fetchAlarmRecords } from '@/platforms/visual/api';
import type { AlarmRecord } from '@/platforms/visual/types/alarm';
import AlarmRecordIcard from '@/platforms/visual/components/alarm/AlarmRecordIcard.vue';
