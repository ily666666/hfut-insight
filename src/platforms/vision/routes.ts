...
export const visionRoutes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () => import('@/platforms/vision/views/analysis/PlanDetail.vue'),
        meta: {
          title: '分析计划详情',
          secondary: 'plan',
          platform: 'vision',
      ...
      },
      {
        ...
        component: () => import('@/platforms/vision/views/analysis/TaskDetail.vue'),
        meta: {
          title: '分析任务详情',
          secondary: 'plan',
          platform: 'vision',
      ...
      {
        path: 'event/manage',
        name: 'AnalysisEventRecord',
        component: () => import('@/platforms/vision/views/analysis/EventRecord.vue'),
        meta: {
          title: '事件记录',
          secondary: 'event-record',
          pageActions: listPage,
          platform: 'vision',
        },
      },
      {
        path: 'event/rejudge',
        name: 'AnalysisRejudgeRecord',
        component: () => import('@/platforms/vision/views/analysis/RejudgeRecord.vue'),
        meta: {
          title: '复判记录',
          secondary: 'event-record',
          platform: 'vision',
      ...
      { path: 'analysis-tasks', redirect: visionPath('analysis', 'plan') },
      { path: 'events', redirect: visionPath('analysis', 'plan') },
      { path: 'statistics', redirect: visionPath('analysis', 'plan') },
      {
        path: 'app-notify',
  ...
  {
    path: visionPath('skill-store'),
    component: AppLayout,
    redirect: visionPath('skill-store', 'list'),
    meta: { platform: 'vision', primary: 'skill-store', hideSecondary: true },
    children: [
      {
        path: 'list',
        name: 'SkillStoreList',
