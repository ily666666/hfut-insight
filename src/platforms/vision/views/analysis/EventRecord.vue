...
function goToRejudge() {
  router.push('/vision/analysis/event/rejudge');
}
</script>

<template>
  <div class="official-page event-record-page">
    <div class="official-page-head" style="position: sticky; top: 0; z-index: 10;">
      <h1 class="official-page-title">事件记录</h1>
      <a-button @click="goToRejudge">复判记录</a-button>
    </div>
